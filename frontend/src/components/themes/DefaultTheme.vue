    ...
    <div class="card-container">
      ...
      <div class="profile-main-split">
        ...
        <div class="profile-left">
          ...
          <div class="profile-info-and-social" style="display: flex; justify-content: space-between; align-items: flex-end; gap: 16px; width: 100%;">
          ...
          <div class="about-myself-content" v-if="employee.about_myself || employee.about_us">
      ...
      <template v-if="Object.keys(groupedAttachments).length > 0">
        <template v-for="(typeGroups, typeName) in groupedAttachments" :key="typeName">
          <template v-for="(files, groupName) in typeGroups" :key="groupName">
            <div class="premium-attachment-section">
              <div class="section-header premium-accordion-header" style="flex-direction: column; align-items: flex-start; gap: 4px;">
                <h3>{{ typeName || 'Attachments' }}</h3>
                <h2 class="premium-group-badge" style="margin: 0; font-size: 24px; font-weight: 700; color: #0f172a;">{{ groupName }}</h2>
              </div>
