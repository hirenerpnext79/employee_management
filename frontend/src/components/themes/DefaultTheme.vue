      ...
      <div class="profile-main-split">
        ...
        <div class="profile-left">
          ...
          <div class="action-buttons-grid">
            <a :href="'https://wa.me/' + (employee.mobile_no ? employee.mobile_no.replace(/\D/g,'') : '')" target="_blank" class="btn-premium btn-whatsapp" v-if="employee.mobile_no" @click="trackEvent('Click', 'WhatsApp')">
              Chat on WhatsApp
            </a>
            <!-- About Myself Toggle Button -->
            <button class="btn-premium btn-about" @click="toggleAboutMyself">
              About Myself
            </button>
            <a :href="'/' + employee.vcard_id + '/' + employee.company_page_route" class="btn-premium btn-company" v-if="employee.company_page_route" @click="trackEvent('Click', 'Company Page')">
              Company Page
            </a>
            <a :href="'/' + employee.vcard_id + '/' + employee.product_page_route" class="btn-premium btn-company" v-if="employee.product_page_route" @click="trackEvent('Click', 'Product Page')">
              Product Page
            </a>
            <a :href="'/api/method/employee_management.api.download_vcard?employee=' + employee.name" class="btn-premium btn-save" @click="trackEvent('Click', 'Save Contact')">
              Save Contact
            </a>
          </div>
          
          <!-- About Myself Collapsible Section -->
          <div class="about-myself-content" v-if="showAboutMyself">
            <div v-html="employee.about_myself || employee.about_us || '<p>No details provided.</p>'"></div>
          </div>
        </div>
