      ...
      <div class="profile-main-split">
        ...
        <div class="profile-right qr-inline">
          ...
          <div class="action-buttons-grid" style="margin-top: 16px; width: 100%; display: flex; flex-direction: column; gap: 10px;">
            ...
            <a :href="'/api/method/employee_management.api.download_vcard?employee=' + employee.name" class="btn-premium btn-company" @click="trackEvent('Click', 'Save Contact')" style="width: 100%; background: #ef4444; color: #fff; border-color: #ef4444;">
              Save Contact
            </a>
          </div>
        </div>
