  ...
  <div class="premium-theme-wrapper">
    <div class="card-container">
      ...
      <div class="quick-contact">
        <a :href="'tel:' + (employee.phone || employee.mobile_no)" class="contact-pill" v-if="employee.phone || employee.mobile_no" @click="trackEvent('Click', 'Phone')" >
        ...
        <a :href="'https://wa.me/' + (employee.mobile_no ? employee.mobile_no.replace(/\D/g,'') : '')" target="_blank" class="contact-pill" v-if="employee.mobile_no" @click="trackEvent('Click', 'WhatsApp')" >
        ...
        <a :href="'mailto:' + employee.email" class="contact-pill" v-if="employee.email" @click="trackEvent('Click', 'Email')" >
          <div class="pill-icon email-icon">
            <svg viewBox="0 0 24 24" fill="currentColor"><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/></svg>
          </div>
        </a>
        <a :href="employee.location || '#'" target="_blank" class="contact-pill" v-if="employee.location" @click="trackEvent('Click', 'Location')" >
      ...
      <div class="social-wrapper" v-if="employee.social_media && employee.social_media.length > 0">
        <a v-for="social in employee.social_media" :key="social.name" :href="social.url" target="_blank" class="social-circle" :title="social.social_media" @click="trackEvent('Click', social.social_media)" >
