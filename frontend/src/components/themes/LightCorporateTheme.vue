  ...
  <div class="card">
    ...
    <div style="position: relative;">
      <div class="banner" :style="employee.header_image ? { backgroundImage: 'url(' + employee.header_image + ')', backgroundSize: 'cover', backgroundPosition: 'center' } : {}">
        <svg class="deco" viewBox="0 0 900 170" preserveAspectRatio="none" v-if="!employee.header_image">
          ...
          <path d="M0 150 C 250 110, 450 170, 700 130 S 900 100, 900 100 L900 170 L0 170Z" fill="#F1ECDF"/>
        </svg>
      </div>
      <div class="avatar">
    ...
    <div class="body-grid">
      ...
      <div class="side-panel">
        ...
        <div style="text-align: center; margin-top: 6px; margin-bottom: 10px; font-size: 15px; font-weight: 700; color: #1e293b; letter-spacing: 0.5px;">ID: {{ employee.vcard_id || employee.name }}</div>
...
<style scoped>
  ...
  *{box-sizing:border-box;}
  .card{width:100%;max-width:100%;margin:0 auto;background:var(--panel);min-height:100vh;
    box-shadow:0 0 60px rgba(0,0,0,.04);font-family:'Inter',sans-serif;color:#1A2233;}
  ...
  .file-name{font-size:14px;color:#1A2233;flex:1;}
  .chev{color:#6B7280;}
