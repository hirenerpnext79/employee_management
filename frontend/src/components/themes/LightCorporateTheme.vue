  ...
  <div class="card">
    ...
    <div class="body-grid">
      ...
      <div class="side-panel">
          ...
          <div style="text-align: center; margin-bottom: 16px; font-size: 16px; font-weight: 700; color: #1e293b; letter-spacing: 0.5px;">ID: {{ employee.vcard_id || employee.name }}</div>
